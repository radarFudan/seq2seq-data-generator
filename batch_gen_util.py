...
def shift_gen(num_per_para):
    ...
    for index, shift in enumerate(shifts):
        ...
        in_name = f'in_{index}.pickle'
        out_name = f'out_{index}.pickle'
...
def twopart_gen(num_per_para):
    ...
    # generate
    for index_1, d1 in enumerate(d1s):
        if d1 == 'close':
            for index_2, sigma2 in enumerate(sigma2s): 
                for index_3, d2 in enumerate(d2s):
                    name = str
                    para = {
                            'centers': [[d2/3, d2]],
                            'sigmas':[[1, sigma2]],
                    ...
                    in_name = f'in_{index_1}_{index_2}_{index_3}.pickle'
                    out_name = f'out_{index_1}_{index_2}_{index_3}.pickle'
...
def exppeak_gen(num_per_para):
    ...
    # generate
    for index_1, center in enumerate(centers):
        for index_2, l in enumerate(lambdas):
            para = {
                'input_dim' : 1,
                'center' : [center],
                'sigmas' : [1],
            ...
            in_name = f'in_{index_1}_{index_2}.pickle'
            out_name = f'out_{index_1}_{index_2}.pickle'
